package com.example.gmailsimapp.adapters
...
import com.example.gmailsimapp.R
import com.example.gmailsimapp.models.EmailModel
    ...
    class EmailViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        init {
            star.setOnClickListener ( View.OnClickListener() {
                ...
                Toast.makeText(itemView.context, "Đã gắn sao cho mail ", Toast.LENGTH_SHORT).show()
            })
        }
    }
    ...
    override fun onBindViewHolder(holder: EmailAdapter.EmailViewHolder, position: Int) {
        ...
        holder.star.setOnClickListener ( View.OnClickListener() {
            ...
            if (email.isStarred) {
                ...
                Toast.makeText(holder.itemView.context, "Đánh dấu mail là quan trọng", Toast.LENGTH_SHORT).show()
            }
            else {
                holder.star.setImageResource(R.drawable.baseline_star_border_24)
                Toast.makeText(holder.itemView.context, "Bỏ đánh dấu mail quan trọng", Toast.LENGTH_SHORT).show()
            }
        })
    }
